(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof define === 'function' && define.amd)
		...
		exports["rs-page"] = factory(require("react"));
	else
		root["rs-page"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageBase = __webpack_require__(2);

	var _PageBase2 = _interopRequireDefault(_PageBase);

	var _PageLayout = __webpack_require__(4);

	var _PageLayout2 = _interopRequireDefault(_PageLayout);

	var _PageRouter = __webpack_require__(72);
	...
	var Page = {
	  PageBase: _PageBase2.default,
	  PageLayout: _PageLayout2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageBase = function (_Component) {
	  ...
	  function PageBase(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PageBase).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PageBase2 = __webpack_require__(2);

	var _PageBase3 = _interopRequireDefault(_PageBase2);
	...
	var PageLayout = function (_PageBase) {
	  _inherits(PageLayout, _PageBase);
	  ...
	  function PageLayout() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PageLayout)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.containerClass = 'salt-pagelayout', _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(PageLayout, [{
	    ...
	    value: function renderHeader() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Header2.default, { dataList: this.header, navList: this.headerNav })
	      );
	    }
	  }, {
	    key: 'renderMain',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rsBreadcrumb = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _crumb = __webpack_require__(7);
	...
	var BreadCrumb = function (_Component) {
	    ...
	    _createClass(BreadCrumb, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement('ol', { className: prefixName + '-breadcrumb' }, this._renderContent());
	        }
	    }], [{
	        key: 'propTypes',
	        value: {
	...
	BreadCrumb.Crumb = _crumb2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Crumb = function Crumb(props) {
			return _react2['default'].createElement('li', { className: props.className }, props.href !== undefined ? _react2['default'].createElement('a', { href: props.href }, props.children) : _react2['default'].createElement('span', null, props.children));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexLink2 = __webpack_require__(49);
	...
	var _IndexRedirect2 = __webpack_require__(52);

	var _IndexRedirect3 = _interopRequireDefault(_IndexRedirect2);

	var _IndexRoute2 = __webpack_require__(54);
	...
	var _Route2 = __webpack_require__(55);

	var _Route3 = _interopRequireDefault(_Route2);

	var _History2 = __webpack_require__(56);
	...
	var _RouteContext2 = __webpack_require__(58);

	var _RouteContext3 = _interopRequireDefault(_RouteContext2);

	var _useRoutes2 = __webpack_require__(59);
	...
	var _RoutingContext2 = __webpack_require__(60);
	...
	var _applyRouterMiddleware2 = __webpack_require__(66);

	var _applyRouterMiddleware3 = _interopRequireDefault(_applyRouterMiddleware2);

	var _browserHistory2 = __webpack_require__(67);

	var _browserHistory3 = _interopRequireDefault(_browserHistory2);

	var _hashHistory2 = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RouterUtils = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBasename = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function Footer() {
	  return _react2.default.createElement("a", { href: "http://lesalt.cn/", className: "logo", target: "_blank" });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createLayout = function createLayout(superclass, _ref) {
	  var trace = _ref.trace;
	  var title = _ref.title;
	  var nav = _ref.nav;
	  var useNav = _ref.useNav;
	...
	var filterRule = function filterRule(routes, trace, rootPath) {
	  var result = [];
	...
	var filterNav = function filterNav(routes) {
	...
	var App = function (_Component2) {
	  ...
	  function App() {
	    ...
	    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this3), _this3.rules = {}, _temp), _possibleConstructorReturn(_this3, _ret);
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      var routes = _rules.routes;
	      var title = _rules.title;
	      var useNav = _rules.useNav;

	      var ruleList = filterRule(routes, false, routes[0].path);
	      var root = ruleList.shift();
	      var nav = filterNav(routes);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _reactRouter.Route,
	          { path: root.path, component: Layout },
	          _react2.default.createElement(_reactRouter.IndexRoute, { component: createLayout(root.component, { trace: root.trace, title: title, nav: nav, useNav: useNav }) }),
	          ruleList.map(function (item) {
	            return _react2.default.createElement(_reactRouter.Route, {
	              key: item.path,
	              path: item.path,
	              component: createLayout(item.component, { trace: item.trace, title: title, nav: nav, useNav: useNav })
	            });
	          })
	        )
	      );
